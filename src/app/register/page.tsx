...
import { User, Lock, Loader2, Mail, Phone } from "lucide-react";
    ...
    <main className="min-h-screen bg-cream flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="font-tiro text-3xl text-text-dark">রেজিস্ট্রেশন করুন</h1>
          <p className="text-sm text-text-light mt-2">নতুন একাউন্ট খুলতে নিচের তথ্যগুলো দিন</p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-2xl shadow-clay/10 border border-cream-dark">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              {loading ? <Loader2 className="animate-spin" size={20} /> : "রেজিস্ট্রেশন সম্পন্ন করুন"}
            </button>
          </form>
          
          <div className="mt-8 text-center text-sm">
            <span className="text-text-light">আগে থেকেই একাউন্ট আছে? </span>
